...
//SoftwareSerial UIPort(17, 16); //(RX,TX) 2-> (17,16) 3-> (15,14)
//SoftwareSerial UIPort(15, 14); //(RX,TX) 2-> (17,16) 3-> (15,14)
//SoftwareSerial portThree(15, 14); //(RX,TX) 2-> (17,16) 3-> (15,14)

//HardwareSerial UIPort(15, 14); //(RX,TX) 2-> (17,16) 3-> (15,14)

//int Rcv 15;
//int Tcv 14;
//HardwareSerial UIPort(int Rcv, int Tcv); //(RX,TX) 2-> (17,16) 3-> (15,14)
#include  "Math.h"
#include  "Defs.h"
#include  "Variables.h"
#include  "DAQ.h"
