...
struct TaskOrg
{
 ...
 TaskOrg Loop;
#define TASK_100MSEC  1
#define TASK_500MSEC  2
#define TASK_1SEC 4
#define TASK_2SEC 8
#define TASK_5SEC 16
#define TASK_10SEC 32
#define TASK_20SEC 64
#define TASK_60SEC 128  
...
char UIPort_rxarr[numChars]; // an array to store the received data
boolean UIPort_newData = false;
